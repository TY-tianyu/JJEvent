...
public final class Event {
    ...
    public static void screen(String sn, LTPType ltp, Map ecp) {
        ...
        try {
            ...
            e.printStackTrace();
            Logger.logWrite(Constant.TAG, "expose " + e.getMessage());
    ...
    public static void event(String ec, String ea, String el, Map ecp) {
        ...
        try {
            ...
            e.printStackTrace();
            Logger.logWrite(Constant.TAG, "event error " + e.getMessage());
    ...
    public static synchronized void expose(String exposeID, String ec, String ea, Map ecp) {
        ...
        try {
            ...
            e.printStackTrace();
            Logger.logWrite(Constant.TAG, "expose error " + e.getMessage());
