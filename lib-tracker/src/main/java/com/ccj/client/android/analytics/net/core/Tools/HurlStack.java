...
import com.ccj.client.android.analytics.Logger;
...
public class HurlStack implements HttpStack {
    ...
    public HttpResponse performRequest(Request<?> request, Map<String, String> additionalHeaders)
        ...
        if (EventManager.IS_DEBUG && !url.endsWith("jpg")) {
            String postParams = "";
            if (request.getBody() != null) {
                postParams = "?" + new String(request.getBody());
            }
            Logger.logWrite("JJEvent-->", request.getMethod() + " " + url + postParams);
        }
    ...
    private HttpURLConnection openConnection(URL url, Request<?> request) throws IOException {
        ...
        connection.setRequestProperty("User-agent",EDeviceUtils.getUserAgent(EventManager.getContext()));
