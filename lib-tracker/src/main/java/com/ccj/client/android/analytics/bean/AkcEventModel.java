...
import com.ccj.client.android.analytics.Constant;
...
import static com.ccj.client.android.analytics.EventManager.getIMEI;
...
public class AkcEventModel {
    ...
    public static class Builder {
        ...
        private AkcEventModel model;

        public Builder(Context context) {
            this.context = context;
            this.model = AkcEventModel.makeModel(context);

        }

        public Builder setActionType(AkcEventType akcEventType) {

            if (akcEventType == null){
                throw new IllegalArgumentException("akcEventType 不能为空");
            }
            this.model.setActionType(akcEventType.getType());
            return this;
        }


        public Builder setSpm(String spm) {
            this.model.setSpm(spm);
            return this;
        }


        public Builder setRefSpm(String refSpm) {
            this.model.setRefSpm(refSpm);
            return this;
        }

        public Builder setCurrentProperties(AkcEventModel.CurrentPropertiesBean bean) {
            this.model.setCurrentProperties(bean);
            return this;
        }
        ...
        public Builder setMi(String mi) {
            this.model.setMi(mi);
            return this;
        }
    ...
    public static void setmUserId(String mUserId) {
        AkcEventModel.mUserId = mUserId;
    }

    public static String mUserId = null;

    public static AkcEventModel makeModel(Context context){
        AkcEventModel model = new AkcEventModel();

//        model.setActionType(EConstant.AkcEventType.);

        model.setDownload(Constant.DownloadChannel);

        model.setClientId(EventManager.getClientId());
        model.setClientTs(System.currentTimeMillis());
//        model.setMi();
        model.setNetwork(getAPNTypeName(context));
        model.setCarrier(getOperators(context));
        model.setOrientation(0);
        model.setLogType("user");

        model.setAppVersion(Constant.AppVersion);

        // IMEI
        if (!TextUtils.isEmpty(getIMEI(context))) {

            model.setDeviceIdType(DeviceIdType.IMEI.getTypeName());
            model.setDeviceId(getIMEI(context));

        } else if (!TextUtils.isEmpty(Settings.System.getString(context.getContentResolver(), Settings.System.ANDROID_ID))){
            // ANDROID_ID
    ...
    public static class CurrentPropertiesBean {
        ...
        public CurrentPropertiesBean setActivityId(String activity_id) {
            this.activity_id = activity_id;
            return this;
        }

        public CurrentPropertiesBean setImageId(String image_id) {
            this.image_id = image_id;
            return this;
        }

        public CurrentPropertiesBean setImgUrl(String img_url) {
